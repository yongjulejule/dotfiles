# Generated by Powerlevel10k configuration wizard on 2021-08-21 at 13:27 KST.
...
#		kubecontext
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$violet
  ...
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }'
	...
	# NOTE : MY config - kubectl command

	typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|k9s'

  # Grey current time.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$violet
  # Format for the current time: 09:51:02. See `man 3 strftime`.
  typeset -g POWERLEVEL9K_TIME_FORMAT='이번엔 다르다!⏰ %D{%H:%M:%S}'
